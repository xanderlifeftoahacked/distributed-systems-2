...
public final class Constants {
    ...
    public static final String LAMPORT = "lamport";
    public static final String MODE = "mode";
    public static final String TOPOLOGY = "topology";
    public static final String STAR_CENTER_NODE_ID = "starCenterNodeId";
    ...
    public static final String ERROR_INVALID_MODE = "INVALID_MODE";
    public static final String ERROR_INVALID_TOPOLOGY = "INVALID_TOPOLOGY";
    public static final String ERROR_INVALID_CONFIG = "INVALID_CONFIG";
    public static final String ERROR_NOT_LEADER_FOR_WRITE = "NOT_LEADER_FOR_WRITE";
    ...
    public static final String TOPOLOGY_MESH = "mesh";
    public static final String TOPOLOGY_RING = "ring";
    public static final String TOPOLOGY_STAR = "star";
